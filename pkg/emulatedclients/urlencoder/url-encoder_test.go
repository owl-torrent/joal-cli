...
func TestUrlEncoder_Encode(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "ShouldUrlEncode", fields: fields{EncodedHexCase: casing.Lower}, args: args{str: string(0x00)}, want: "%00"},
		{name: "ShouldUrlEncode", fields: fields{EncodedHexCase: casing.Lower}, args: args{str: string(0x01)}, want: "%01"},
		{name: "ShouldUrlEncode", fields: fields{EncodedHexCase: casing.Lower}, args: args{str: string(0x10)}, want: "%10"},
		{name: "ShouldUrlEncode", fields: fields{EncodedHexCase: casing.Lower}, args: args{str: string(0x1e)}, want: "%1e"},
		{name: "ShouldUrlEncode", fields: fields{EncodedHexCase: casing.Lower}, args: args{str: string(0x20)}, want: "%20"},
		{name: "ShouldUrlEncode", fields: fields{EncodedHexCase: casing.Lower}, args: args{str: string(0x1A)}, want: "%1a"},
